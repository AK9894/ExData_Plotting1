...
lines(household$datetime, household$Sub_metering_2, type = "l", xlab = "", ylab = "Energy sub metering", col = "red")
lines(household$datetime, household$Sub_metering_3, type = "l", xlab = "", ylab = "Energy sub metering", col = "blue")
